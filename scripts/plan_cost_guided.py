...
def train(eval_dataset, eval_seed, eval_threshold):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_dataset', type=str, default='hopper-medium-replay-v2')
    parser.add_argument('--eval_seed', type=int, default=42)
    parser.add_argument('--eval_threshold', type=float, default=25.0)
    args = parser.parse_args()
    train(args.eval_dataset, args.eval_seed, args.eval_threshold)

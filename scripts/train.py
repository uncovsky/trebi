...
class Parser(utils.Parser):
    def __init__(self, dataset: str = 'OfflineHopperVelocityGymnasium-v1',
...
def train(seed, dataset):
    ...
    args = Parser(dataset).parse_args('diffusion')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='OfflineHopperVelocityGymnasium-v1')
    args = parser.parse_args()

    train(args.seed, args.dataset)
